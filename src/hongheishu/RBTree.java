...
//	        RBTree<Integer> fuck = new RBTree<Integer>();
	 	...
	 	public static  List<String> inorderTraversal(RBTree.TreeNode root) {
			List<String> result = new ArrayList<String>();
		    recurse(root, result);
		    return result;
		  }
		   
		  private static void recurse(RBTree.TreeNode  root, List<String> result) {
		    if (root == null) return;
    ...
    static class TreeNode<T extends Comparable<T>> {
		...
		public String toString() {
			return "TreeNode [data=" + data + ", color=" + color + ", isDeleted=" + isDeleted + ", left=" + left
